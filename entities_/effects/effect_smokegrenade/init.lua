...
function EFFECT:Init(data)
	...
	for i = 1, 40 do
		local pos = Vector(
			math.Rand(-20, 20), math.Rand(-20, 20), math.Rand(-20, 20) + 30
		);
		local smoke = particule:Add(
			"particle/particle_smokegrenade", data:GetOrigin() + pos
		);
		if (smoke) then
			...
			smoke:SetColor(
				math.random(220, 240), math.random(220, 240), math.random(220, 240)
			);
			...
			smoke:SetGravity(
				Vector(math.Rand(-10, 10), math.Rand(-10, 10), math.Rand(20, -20))
			);
